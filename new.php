...
<?php require_once "head.php"?>
  ...
  // Query definition
  $sql_s_new = "SELECT product_id,product_name,product_description,picture_album_id,product_mode FROM product ORDER BY product_created_at DESC LIMIT 12;";

  $conn = db();

  if($conn){

  $pop_products = $conn->query($sql_s_new);
  ...
  <div class="jumbotron">
    ...
    <div class="container w-50">
      ...
      if ($pop_products->num_rows > 0) {
          ...
          ?>
          <div class="jumbotron">
              <h1> Oops looks like there are no products yet!</h1>
