...
<?php require_once "head.php"?>
  ...
  // Query definition
  $sql_s_pop = "SELECT product_id,product_name,product_description,picture_album_id,product_mode FROM product ORDER BY product_pop DESC LIMIT 12;";

  $conn = db();

  if($conn){

      $pop_products = $conn->query($sql_s_pop);
  ...
  ?>
    ...
    <div id="popularProducts" class="container text-center mt-5">
      ...
      if ($pop_products->num_rows > 0) {
          ...
          ?>
          <div class="jumbotron">
              <h1> Oops looks like there are no popular products yet!</h1>
