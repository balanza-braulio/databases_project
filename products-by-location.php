...
$p_location = htmlspecialchars($_GET["plocation"]);
...
if ($p_mode == 0) {
    ...
    //Query definition
    $sql_s_prod = "SELECT DISTINCT product_id, product_name, product_description, picture_album_id, product_mode FROM product WHERE location_name = '" . $p_location . "' AND product_mode = 0;";
    ...
    if ($products->num_rows > 0) {
        ...
        <div class="jumbotron">
            <h1> Oops looks like there are no furniture products in that location</h1>
            <p>Please make another search!</p>
            <a class="btn btn-primary" href="locations-of-furniture.php">Go Back to Furniture Locations!</a>
        </div>
...
// If product is room, show only rooms
    ...
    $sql_s_prod = "SELECT DISTINCT product_id, product_name, product_description, picture_album_id, product_mode FROM product WHERE location_name = '" . $p_location . "' AND product_mode = 1;";
    ...
    if ($products->num_rows > 0) {
        ...
        <div class="jumbotron">
            <h1> Oops looks like there are no room products in that location</h1>
            <p>Please make another search!</p>
            <a class="btn btn-primary" href="locations-of-rooms.php">Go Back to Room Locations!</a>
        </div>
