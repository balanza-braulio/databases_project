...
$p_style_id = htmlspecialchars($_GET["pstyle_id"]);
...
if ($p_mode == 0) {
    ...
    //Query definition
    $sql_s_prod = "SELECT DISTINCT product_id, product_name, product_description, picture_album_id, product_mode FROM product WHERE style_id = " . $p_style_id . " AND product_mode = 0;";
    ...
    if ($products->num_rows > 0) {
        ...
        <div class="jumbotron">
            <h1> Oops looks like there are no furniture products with that style</h1>
            <p>Please make another search!</p>
            <a class="btn btn-primary" href="styles-of-furniture.php">Go Back to Furniture Styles!</a>
        </div>
...
// If product is room, show only rooms
    ...
    $sql_s_prod = "SELECT DISTINCT product_id, product_name, product_description, picture_album_id, product_mode FROM product WHERE style_id = " . $p_style_id . " AND product_mode = 1;";
    ...
    if ($products->num_rows > 0) {
        ...
        <div class="jumbotron">
            <h1> Oops looks like there are no room products with that style</h1>
            <p>Please make another search!</p>
            <a class="btn btn-primary" href="styles-of-rooms.php">Go Back to Room Styles!</a>
        </div>
